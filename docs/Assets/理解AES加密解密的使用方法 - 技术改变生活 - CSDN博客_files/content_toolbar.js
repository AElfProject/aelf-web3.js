...
document.write("<scr"+"ipt src='https://g.csdnimg.cn/asdf/23423/counter.js'></scr"+"ipt>");
var _gaq = [];
  ...
  var tpl ='\<div id="csdn-toolbar" class="csdn-toolbar tb_disnone '+skin+fixed+'">\
        <div class="container row center-block ">\
          <ul class="pull-left left-menu clearfix" id="nav-left-menu">\
            ...
            <li class="app-control app-app"><a class="link-title" href="https://www.csdn.net/csdn-app/" title="APP">APP</a>\
              <div class="appControl">\
              <span>\
