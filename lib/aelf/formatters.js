...
var outputProposalFormatter = function (result) {
    var buffer = Buffer.from(result.replace('0x', ''), 'hex');
    return proposalMessage.decode(buffer);
};

module.exports = {
    inputAddressFormatter: inputAddressFormatter,
    outputAbiFormatter: outputAbiFormatter,
    outputProposalFormatter : outputProposalFormatter
};
