...
var getProposal = function (multisig_account, proposal_name, txn_data, expired_time, proposer) {
    console.log('proposal_name - ', proposal_name);
    console.log('multisig_account - ', multisig_account);
    ...
    var proposal = {
        ...
        "Name" : proposal_name,
        "TxnData" : Buffer.from(txn_data.toString('hex'), 'hex'),
        "ExpiredTime" : new Date(expired_time).getTime(),
