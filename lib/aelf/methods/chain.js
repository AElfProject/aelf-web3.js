...
Object.defineProperty(Chain.prototype, 'authorizationContractAddress', {
    get: function () {
        return c.authorizationContractAddress;
    },
    set: function (val) {
        c.authorizationContractAddress = val;
        return val;
    }
});


Object.defineProperty(Chain.prototype, 'authorizationContractAbi', {
    get: function () {
        return c.authorizationContractAbi;
    },
    set: function (val) {
        c.authorizationContractAbi = val;
        return val;
    }
});

Object.defineProperty(Chain.prototype, 'authorizationContract', {
    get: function () {
        return c.authorizationContract;
    },
    set: function (val) {
        c.authorizationContract = val;
        return val;
    }
});
...
Chain.prototype.formatInputAuthorization = function (auth) {
    return formatters.formatInputAuthorization(auth);
};

Chain.prototype.formatOutputAuthorization = function (bytes) {
    var auth = formatters.formatOutputAuthorization(bytes);
    console.log(auth);
    return auth;
};
