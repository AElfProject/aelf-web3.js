...
var formatInputAuthorization =function (auth, fieldNumber) {
    ...
    {
        console.log("PubKey ", auth.Reviewers[i].PubKey);
        console.log("Weight ", auth.Reviewers[i].Weight);
        var reviewer = {
            "PubKey" : formatInputBytes(auth.Reviewers[i].PubKey),
            "Weight" : formatInputUInt(auth.Reviewers[i].Weight)
        };
        console.log("reviewer ", reviewer);
        reviewers[i] = proto.getReviewer(reviewer);
    }
